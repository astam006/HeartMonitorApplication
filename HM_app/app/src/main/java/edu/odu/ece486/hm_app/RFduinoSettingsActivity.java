...
public class RFduinoSettingsActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rfduino_settings);
    ...
    private void addData(byte[] data) {
        ...
        text1.setText(HexAsciiConverter.bytesToHex(data));

        String ascii = HexAsciiConverter.bytesToAsciiMaybe(data);
        if (ascii != null) {
    ...
    public void onLeScan(BluetoothDevice device, final int rssi, final byte[] scanRecord) {
        ...
        RFduinoSettingsActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rfduino_settings, menu);
        return true;
    }
