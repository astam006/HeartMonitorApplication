 ...
 * This class assists our application with converting bytes received
 * from a connected bluetooth device to hex values or vice versa.
 */
public class HexAsciiConverter {
    public static int ASCII_MIN = 0x20;
    public static int ASCII_MAX = 0x7E;
